...
public class OfferEvaluatorTest {
    ...
    public void testReserveTaskAndExecutorDynamicPort() throws InvalidRequirementException, InvalidProtocolBufferException {
        Resource offeredCpu = ResourceTestUtils.getUnreservedCpu(1.0);
        Resource offeredTaskPorts = ResourceTestUtils.getUnreservedPorts(10000, 10000);
        Resource offeredExecutorPorts = ResourceTestUtils.getUnreservedPorts(11000, 11000);
        ...
        OfferRequirement offerReq = new OfferRequirement(
                Arrays.asList(TaskTestUtils.getTaskInfo(Arrays.asList(desiredCpu, desiredDynamicPort))),
                Optional.of(TaskTestUtils.getExecutorInfo(desiredDynamicPort)),
                null,
                null);
        ...
        Assert.assertEquals(TestConstants.PORT_NAME, dynamicPortTaskLabel.getValue());
        ...
        Assert.assertEquals(TestConstants.PORT_NAME, taskVariable.getName());
        Assert.assertEquals(String.valueOf(10000), taskVariable.getValue());
    }
